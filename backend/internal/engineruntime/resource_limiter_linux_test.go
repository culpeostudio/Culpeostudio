...
const (
	linuxLimiterParentHelper = "PHILOENGINE_TEST_LINUX_LIMITER_PARENT"
	linuxLimiterWorkerHelper = "PHILOENGINE_TEST_LINUX_LIMITER_WORKER"
	linuxLimiterPIDFile      = "PHILOENGINE_TEST_LINUX_LIMITER_PID_FILE"
)
