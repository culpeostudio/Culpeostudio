...
const (
	darwinLimiterParentHelper = "CULPEOSTUDIO_TEST_LIMITER_PARENT"
	darwinLimiterWorkerHelper = "CULPEOSTUDIO_TEST_LIMITER_WORKER"
	darwinLimiterPIDFile      = "CULPEOSTUDIO_TEST_LIMITER_PID_FILE"
)
