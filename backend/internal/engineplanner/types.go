...
// The cache types llama.cpp accepts for --cache-type-k/--cache-type-v, plus
// q2_k, which only a build that reports it may use. KVCacheQ4 is q4_0 and is
// the default: it is the smallest type upstream actually supports.
const (
	KVCacheQ4    KVCacheDType = "q4"
	KVCacheQ41   KVCacheDType = "q4_1"
	KVCacheIQ4NL KVCacheDType = "iq4_nl"
	KVCacheQ50   KVCacheDType = "q5_0"
	KVCacheQ51   KVCacheDType = "q5_1"
	KVCacheQ8    KVCacheDType = "q8_0"
	KVCacheFP16  KVCacheDType = "fp16"
	KVCacheBF16  KVCacheDType = "bf16"
	KVCacheFP32  KVCacheDType = "fp32"
	KVCacheQ3K   KVCacheDType = "q3_k"
	KVCacheQ2K   KVCacheDType = "q2_k"
)
