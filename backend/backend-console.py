...
class BackendConsoleApp(App):
    ...
    async def on_mount(self) -> None:
        ...
        await asyncio.gather(
            ...
            self._ensure_culpeostudio_hardware_dependency(),
    ...
    async def _ensure_culpeostudio_hardware_dependency(self) -> bool:
        """Install the optional upstream detector for Culpeo Studio.
        ...
        if await check.wait() == 0:
            self._log(
                "Culpeo Studio hardware detection is ready.",
        ...
        self._log(
            "Installing Culpeo Studio hardware detection dependency.",
            source="hardware.dependencies",
        )
        ...
        if install.returncode != 0:
            self._log(
                "Culpeo Studio hardware detection dependency could not be installed; "
