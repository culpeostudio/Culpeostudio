...
func (e *Executor) searchRoot(args map[string]interface{}) (string, error) {
...
func (e *Executor) grepSearch(args map[string]interface{}) (map[string]interface{}, error) {
...
func (e *Executor) findFiles(args map[string]interface{}) (map[string]interface{}, error) {
	pattern, _ := args["pattern"].(string)
	maxResults := clampMaxResults(args)
...
// DirTreeEntry is one node of the folder listing the UI renders. It is
// exported because the scout module puts it on the wire.
