...
type Overview struct {
	...
	MetricStats  []MetricStats      `json:"metric_stats"`
	TopOverall   []Entry            `json:"top_overall"`
	TopByMetric  map[string][]Entry `json:"top_by_metric"`

	TopOpenWeights  []Entry            `json:"top_open_weights"`
	TopOpenByMetric map[string][]Entry `json:"top_open_by_metric"`
	TypeShare       []FacetValue       `json:"type_share"`
	OrgShare        []FacetValue       `json:"org_share"`
}
