		...
		items: []NewsItem{
			{
				...
				Title:       "Show HN: Culpeo Studio – Local AI Orchestration in Go",
				Content:     "Culpeo Studio is an open-source framework written in Go designed to run, quantize, and serve language and image diffusion models locally with minimal overhead. It provides clean gRPC and REST interfaces.",
				Author:      "Hacker News",
