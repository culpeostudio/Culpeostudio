...
func (m *EngineModule) validateLoadPeakWithNormalLRU(ctx context.Context, record modelcatalog.ModelRecord, plan ContextPlanView, operationID, primaryID string) (int64, error) {
	return m.evictNormalLRUUntilPeakAdmittedWithClaim(ctx, func() *EngineInstance {
		...
		return m.validateLoadPeak(ctx, record, plan)
	}, func(candidate *EngineInstance) error {
