...
import 'package:culpeo_studio/modules/bots/bot_management_screen.dart';
import 'package:culpeo_studio/modules/scout/bot_picker.dart';
import 'package:culpeo_studio/modules/scout/chat_model_picker.dart';
...
void main() {
  ...
  const bots = [
    ScoutChoice(id: 'scout', name: 'Scout', isDefault: true),
    ScoutChoice(id: 'kant', name: 'Kant-Bot', modelBinding: binding),
  ];
