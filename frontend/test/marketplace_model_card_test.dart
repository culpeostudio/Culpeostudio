...
/// Answers the calls the screen fires while it mounts. The API itself is
/// swapped rather than the transport underneath it, because the gRPC channel
/// never connects in a widget test.
class _StubMarketplaceApi extends MarketplaceApi {
  _StubMarketplaceApi() : super(ApiClient());
  ...
  @override
  Future<Map<String, dynamic>> getHardwareProfile() async => const {};

  @override
  Future<Map<String, dynamic>> listDownloadJobs() async => const {'jobs': []};
}
...
void main() {
  setUp(() => ApiService().debugSetMarketplaceApi(_StubMarketplaceApi()));
