...
void main() {
  ...
  testWidgets('picker is disabled when Agentic uses Spark', (tester) async {
    final local = ChatModelChoice.local(
      _instance(id: 'local-instance', state: 'ready', name: 'Lokales Modell'),
    );
    var selected = false;
        ...
        home: Scaffold(
          body: Center(
            child: ChatModelPicker(
              ...
              choices: [local],
              enabled: false,
              disabledReason: 'Agentic verwendet Spark',
    ...
    expect(find.text('Agentic verwendet Spark'), findsNothing);
  });
