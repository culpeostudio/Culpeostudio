          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: DarkColors.accent.withValues(alpha: 0.7),
      ...
      options: [
        ...
        for (final facet in _page.orgs)
          BenchmarkFilterOption(
            value: facet.value,
            label: facet.value,
            color: benchmarkOrgBrand(facet.value).color,
            count: facet.count,
          ),
      ],
      onSelected: (value) {
          ...
          children: [
            ...
            if (_hasActiveFilters) ...[
              ...
              TextButton(
                onPressed: _clearOwnFilters,
                child: Text(
                  tr('benchmark.filterReset'),
                  style: const TextStyle(color: DarkColors.accent),
                ),
              ),
            ],
          ],
