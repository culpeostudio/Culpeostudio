const Map<String, String> engineStringsDe = {
  ...
  'engineWidget.instance.description.installing':
      'PhiloEngine richtet die benötigten Komponenten im Hintergrund ein. Danach startet das Modell automatisch.',
  ...
  'engineWidget.restartField.trustRemoteCode': 'Modellcode-Freigabe',
};
...
const Map<String, String> engineStringsEn = {
  ...
  'engineWidget.instance.description.installing':
      'PhiloEngine is setting up the required components in the background. The model will start automatically afterwards.',
  'engineWidget.instance.description.queued':
  ...
  'engineWidget.restartField.trustRemoteCode': 'Model code approval',
};
