...
const Map<String, String> marketplaceScreenStringsDe = {
  ...
  'marketplaceScreen.filters.quickSelection': 'Schnellauswahl',
  'marketplaceScreen.filters.collapse': 'Filter reduzieren',
  'marketplaceScreen.filters.showAll': 'Alle Filter',
  'marketplaceScreen.filters.compactHelp':
      'Suche nach einem Modell oder wähle eine einfache Empfehlung. Die Variante „Ausgewogen“ ist später für die meisten Geräte passend.',
  'marketplaceScreen.filters.localModels': 'Lokale Modelle',
  'marketplaceScreen.filters.fitsMyPc': 'Passt auf meinen PC',
  ...
  'marketplaceScreen.model.startInChat': 'Im Chat starten',
  ...
  'marketplaceScreen.price.inputOutput':
      'In {input} / Out {output} pro 1M Tokens',
...
const Map<String, String> marketplaceScreenStringsEn = {
  ...
  'marketplaceScreen.filters.quickSelection': 'Quick selection',
  'marketplaceScreen.filters.collapse': 'Show fewer filters',
  'marketplaceScreen.filters.showAll': 'All filters',
  'marketplaceScreen.filters.compactHelp':
      'Search for a model or choose a simple recommendation. The “Balanced” variant is suitable for most devices.',
  'marketplaceScreen.filters.localModels': 'Local models',
  'marketplaceScreen.filters.fitsMyPc': 'Fits my PC',
  'marketplaceScreen.filters.provider': 'Provider',
  ...
  'marketplaceScreen.model.hits': '{count} hits',
  'marketplaceScreen.model.startInChat': 'Start in chat',
  'marketplaceScreen.model.download': 'Download',
  'marketplaceScreen.model.details': 'Details',
  ...
  'marketplaceScreen.price.inputOutput':
      'In {input} / Out {output} per 1M tokens',
