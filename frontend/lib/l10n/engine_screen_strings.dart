...
const Map<String, String> engineScreenStringsDe = {
  ...
  'engineScreen.admin.title': 'Administratorrechte erlauben?',
  'engineScreen.admin.intro':
      'PhiloEngine möchte die fehlenden Vulkan-Build-Abhängigkeiten installieren und danach eine GPU-Runtime bauen.',
  'engineScreen.admin.systemPackages': 'Systempakete',
  'engineScreen.admin.defaultVulkanDependencies': 'Vulkan-Build-Abhängigkeiten',
  'engineScreen.admin.plannedAction': 'Geplante Aktion',
  'engineScreen.admin.systemDialogInfo':
  ...
  'engineScreen.admin.oneTimePermission':
  ...
  'engineScreen.admin.acknowledgement':
      'Ich habe die geplante Systemänderung verstanden.',
  'engineScreen.action.cancel': 'Abbrechen',
  'engineScreen.admin.openSystemDialog': 'Systemdialog öffnen',
  ...
  'engineScreen.remoteCode.title': 'Modellcode ausführen?',
  'engineScreen.remoteCode.content':
      '„{model}“ enthält eigenen Python-Code, den die Runtime zum Laden ausführen möchte.',
  'engineScreen.remoteCode.warning':
  ...
  'engineScreen.remoteCode.pythonFiles': 'Python-Dateien: {count}',
  'engineScreen.remoteCode.hash': 'Hash: {hash}',
  'engineScreen.remoteCode.accept': 'Zustimmen & starten',
  ...
  'engineScreen.model.summary': '{size} · bis zu {tokens} Token Kontext',
  'engineScreen.model.expertSummary':
      '{format} · {quantization} · {size} · {tokens} Token',
  ...
  'engineScreen.field.native': 'Nativ',
  ...
  'engineScreen.field.allowModelPython': 'Modelleigenen Python-Code erlauben',
  'engineScreen.field.remoteCodeSafeTensorsHelp':
      'Standardmäßig aus. Vor der ersten Ausführung ist eine hashgebundene Zustimmung nötig.',
  'engineScreen.field.remoteCodeOtherHelp':
  ...
  'engineScreen.operation.runtimeTransformers': 'SafeTensors-Ausführung',
  'engineScreen.operation.runtimeTransformersSource': 'Runtime transformers',
  ...
  'engineScreen.runtimeError.packageUnavailable':
      'Für dieses System ist das benötigte Paket nicht verfügbar. PhiloEngine versucht, eine kompatible Alternative zu verwenden.',
...
const Map<String, String> engineScreenStringsEn = {
  ...
  'engineScreen.memory.setupGpu': 'Set up GPU automatically',
  'engineScreen.memory.useCpuRam': 'Use CPU/RAM',
  'engineScreen.memory.useRam': 'Use RAM',
  'engineScreen.error.gpuSetupPreparationFailed':
      'Automatic GPU setup could not be prepared.',
  'engineScreen.error.gpuSetupCancelled':
      'GPU setup was not started. No system changes were made.',
  'engineScreen.error.gpuSupportSetupFailed':
      'GPU support could not be set up automatically.',
  'engineScreen.error.gpuRuntimeRebuildFailed':
      'The Vulkan GPU runtime could not be rebuilt.',
  'engineScreen.admin.title': 'Allow administrator permissions?',
  'engineScreen.admin.intro':
      'PhiloEngine wants to install the missing Vulkan build dependencies and then build a GPU runtime.',
  'engineScreen.admin.systemPackages': 'System packages',
  'engineScreen.admin.defaultVulkanDependencies': 'Vulkan build dependencies',
  'engineScreen.admin.plannedAction': 'Planned action',
  'engineScreen.admin.systemDialogInfo':
      'The operating system will then open its own administrator dialog. PhiloEngine neither sees nor stores your password.',
  'engineScreen.admin.oneTimePermission':
      'This permission applies only to this attempt. You will be informed again and must consent again before any future system change.',
  'engineScreen.admin.acknowledgement':
      'I understand the planned system change.',
  'engineScreen.action.cancel': 'Cancel',
  'engineScreen.admin.openSystemDialog': 'Open system dialog',
  ...
  'engineScreen.remoteCode.title': 'Run model code?',
  'engineScreen.remoteCode.content':
      '“{model}” contains custom Python code that the runtime wants to execute while loading.',
  'engineScreen.remoteCode.warning':
      'The child process is not a sandbox. Malicious model code can access files and other resources in your user account.',
  'engineScreen.remoteCode.info':
      'Your consent applies only to the current model fingerprint and the hash of the Python files. If a file changes, PhiloEngine asks again.',
  'engineScreen.remoteCode.pythonFiles': 'Python files: {count}',
  'engineScreen.remoteCode.hash': 'Hash: {hash}',
  'engineScreen.remoteCode.accept': 'Consent & start',
  'engineScreen.notification.refreshed':
  ...
  'engineScreen.model.summary': '{size} · up to {tokens} tokens of context',
  'engineScreen.model.expertSummary':
      '{format} · {quantization} · {size} · {tokens} tokens',
  ...
  'engineScreen.field.native': 'Native',
  'engineScreen.field.kvCachePolicy': 'KV cache policy',
  'engineScreen.field.kvCachePolicyHelp':
  ...
  'engineScreen.field.allowModelPython': 'Allow model-provided Python code',
  'engineScreen.field.remoteCodeSafeTensorsHelp':
      'Off by default. A hash-bound consent is required before the first execution.',
  'engineScreen.field.remoteCodeOtherHelp':
      'Relevant only for SafeTensors models with custom Python code.',
  'engineScreen.field.autostart': 'Autostart',
  'engineScreen.field.autostartHelp':
  ...
  'engineScreen.operation.runtimeLlamaCppSource': 'Runtime llama_cpp',
  'engineScreen.operation.runtimeTransformers': 'SafeTensors execution',
  'engineScreen.operation.runtimeTransformersSource': 'Runtime transformers',
  ...
  'engineScreen.runtimeError.packageUnavailable':
      'The required package is not available for this system. PhiloEngine will try to use a compatible alternative.',
  'engineScreen.runtimeError.nativeBuildFailed':
