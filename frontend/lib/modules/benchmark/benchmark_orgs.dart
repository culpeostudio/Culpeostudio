...
const Color _neutralOrgColor = CulpeoColors.metric;
...
const Map<String, String> _orgDisplayNames = {
  'openai': 'OpenAI',
  'anthropic': 'Anthropic',
  'google': 'Google',
  'meta': 'Meta',
...
String formatOrgName(String org) {
  final raw = org.trim();
  ...
  final known = _orgDisplayNames[resolved] ?? _orgDisplayNames[key];
  if (known != null) return known;
