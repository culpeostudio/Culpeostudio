...
const Map<String, String> chatAuxStringsDe = {
  ...
  'chatAux.modelManagement.reorder': 'Im Ordner sortieren',
  ...
  'chatAux.sidebarModel.notReady': 'Öffne den Chat, um Modelle zu laden',
  'chatAux.sidebarModel.refresh': 'Modelle aktualisieren',
  'chatAux.sidebarModel.openEngine': 'Engine öffnen',
  'chatAux.sidebarModel.warmupCancel': 'Abbrechen',

  'chatAux.modelFolder.titleNew': 'Neuer Ordner',
  'chatAux.modelFolder.titleEdit': 'Ordner bearbeiten',
  'chatAux.modelFolder.nameHint': 'Ordnername',
  'chatAux.modelFolder.nameError': 'Bitte einen Namen eingeben',
  'chatAux.modelFolder.colorLabel': 'FARBE',
  'chatAux.modelFolder.deleteTitle': 'Ordner löschen?',
  'chatAux.modelFolder.deleteBody':
      '„{name}" wird gelöscht. Die enthaltenen Modelle bleiben erhalten und wandern zurück in die allgemeine Liste.',
  'chatAux.modelFolder.local': 'LOKAL',
  'chatAux.modelFolder.edit': 'Ordner bearbeiten',
...
const Map<String, String> chatAuxStringsEn = {
  ...
  'chatAux.permission.body':
      'Scout wants to work outside the project path ({tool}):',
  ...
  'chatAux.modelManagement.reorder': 'Sort inside folder',
  ...
  'chatAux.sidebarModel.notReady': 'Open the chat to load models',
  'chatAux.sidebarModel.refresh': 'Refresh models',
  'chatAux.sidebarModel.openEngine': 'Open Engine',
  'chatAux.sidebarModel.warmupCancel': 'Cancel',

  'chatAux.modelFolder.titleNew': 'New folder',
  'chatAux.modelFolder.titleEdit': 'Edit folder',
  'chatAux.modelFolder.nameHint': 'Folder name',
  'chatAux.modelFolder.nameError': 'Please enter a name',
  'chatAux.modelFolder.colorLabel': 'COLOR',
  'chatAux.modelFolder.deleteTitle': 'Delete folder?',
  'chatAux.modelFolder.deleteBody':
      '"{name}" will be deleted. Its models are kept and move back to the '
      'general list.',
  'chatAux.modelFolder.local': 'LOCAL',
  'chatAux.modelFolder.edit': 'Edit folder',
