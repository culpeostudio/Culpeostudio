...
class _ModelManagementDialogState extends State<ModelManagementDialog> {
  ...
  Widget build(BuildContext context) {
    ...
    if (_searchQuery.isNotEmpty) {
      ...
      // This dialog only ever knew about cloud models; a folder can also
      // hold local ones now, and those have no entry in [allModels] to
      // render a name from.
      displayedModels = folder.modelIds.where(allModels.contains).toList();
    }
