...
class _LoginScreenState extends State<LoginScreen> {
  ...
  InputDecoration _inputDecoration(
    ...
    return InputDecoration(
      ...
      focusedBorder: const OutlineInputBorder(
        ...
        borderSide: BorderSide(color: CulpeoColors.metric, width: 1.5),
      ),
  ...
  Widget _loadingContent() {
    return Column(
      ...
      children: [
        ...
        const CircularProgressIndicator(color: CulpeoColors.metric),
      ],
    );
  }
              ...
              child: Row(
                children: [
                  Checkbox(
                    ...
                    activeColor: CulpeoColors.metric,
  ...
  Widget _sessionChip(String value, String label) {
    return ChoiceChip(
      ...
      selectedColor: CulpeoColors.metric.withValues(alpha: 0.24),
      ...
      side: BorderSide(
        color: _sessionDuration == value
            ? CulpeoColors.metric.withValues(alpha: 0.7)
