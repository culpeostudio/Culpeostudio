...
Please report security issues **privately** to <security@fillystudio.com> —
...
PhiloEngine runs on your own machine, so the interesting areas are:
...
to your user account, and issues in third-party runtimes (llama.cpp, vLLM,
Transformers) — please report those to the respective projects.
